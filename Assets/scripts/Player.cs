...
public class Player : MonoBehaviour{
    ...
    public void AddTurnOverListener(UnityAction<PlayerName, Configuration> listener){
        ...
        while (nodeList.Count > 0){
            ...
            foreach (Configuration child in children){
                ...
                MinimaxTreeNode<Configuration> childNode =
                    new MinimaxTreeNode<Configuration>(child, currentNode);
                if(childNode.Depth <= searchDepth){
    ...
    void Minimax(MinimaxTreeNode<Configuration> tree, bool maximizing){
        // recurse on children
