...
public static class EventManager
{
    ...
    static List<DontTakeTheLastTeddy> takeTurnInvokers =new List<DontTakeTheLastTeddy>();
    static List<UnityAction<PlayerName, Configuration>> takeTurnListeners =new List<UnityAction<PlayerName, Configuration>>();

    static List<Player> turnOverInvokers = new List<Player>();
    static List<UnityAction<PlayerName, Configuration>> turnOverListeners =new List<UnityAction<PlayerName, Configuration>>();

    static List<DontTakeTheLastTeddy> gameOverInvokers = new List<DontTakeTheLastTeddy>();
    static List<UnityAction<PlayerName, int>> gameOverListeners =new List<UnityAction<PlayerName, int>>();

    static List<DontTakeTheLastTeddy> startGameInvokers = new List<DontTakeTheLastTeddy>();
    static List<UnityAction> startGameListeners = new List<UnityAction>();

    static List<DontTakeTheLastTeddy> testOverInvokers = new List<DontTakeTheLastTeddy>();
    static List<UnityAction> testOverListeners = new List<UnityAction>();
    ...
    public static void AddGameOverInvoker(DontTakeTheLastTeddy invoker){
        ...
        foreach (UnityAction<PlayerName, int> listener in gameOverListeners)
    ...
    /// </summary>
    /// <param name="listener">listener</param>
    public static void AddGameOverListener(UnityAction<PlayerName, int> listener){
    ...
    public static void AddStartGameListener(UnityAction listener){
        startGameListeners.Add(listener);
        foreach (DontTakeTheLastTeddy invoker in startGameInvokers)
            invoker.AddStartGameListener(listener);
    }
    ...
    public static void AddTestOverListener(UnityAction listener){
        testOverListeners.Add(listener);
        foreach (DontTakeTheLastTeddy invoker in testOverInvokers)
            invoker.AddTestOverListener(listener);
    }
